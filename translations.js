...
const TRANSLATIONS = {
    ...
    ca: {
        ...
        paintings: {
            "painting-0": { title: "Reflexos de l'Ànima", tech: "Oli sobre llenç", desc: "Una obra íntima que explora les profunditats de la introspecció humana..." },
            "painting-1": { title: "Geometria del Caos", tech: "Acrílic i textures sobre taula", desc: "Aquesta pintura presenta una audaç intersecció de plànols geomètrics..." },
            "painting-2": { title: "Silueta a la Boira", tech: "Tècnica mixta sobre llenç", desc: "La fusió de grafit, carbonet, acrílic i fines capes de pintura..." },
            "painting-3": { title: "Suspirs Urbans", tech: "Tècnica mixta sobre llenç", desc: "Una expressió poètica del moviment i la solitud de les metròpolis..." },
            "painting-4": { title: "Mirada Interior", tech: "Acrílic sobre llenç", desc: "Un retrat expressiu enfocat en la potència de la mirada..." },
            "painting-5": { title: "Camins del Destí", tech: "Acrílic sobre taula", desc: "Línies verticals i horitzontals que s'entrellacen creant camins..." },
            "painting-6": { title: "Horitzó Infinit", tech: "Oli sobre llenç", desc: "Una representació minimalista de la línia del mar i el cel..." }
        }
    },
    gl: {
        nav: {
        ...
        paintings: {
            "painting-0": { title: "Reflexos da Alma", tech: "Óleo sobre lenzo", desc: "Unha obra íntima que explora as profundidades da introspección..." },
            "painting-1": { title: "Xeometría do Caos", tech: "Acrílico e texturas sobre táboa", desc: "Esta pintura presenta unha audaz intersección de planos..." },
            "painting-2": { title: "Silueta na Néboa", tech: "Técnica mixta sobre lenzo", desc: "A fusión de grafito, carbón, acrílico e finas capas..." },
            "painting-3": { title: "Susurros Urbanos", tech: "Técnica mixta sobre lenzo", desc: "Unha expresión poética do movemento e a soidade..." },
            "painting-4": { title: "Mirada Interior", tech: "Acrílico sobre lenzo", desc: "Un retrato expresivo enfocado na potencia da mirada..." },
            "painting-5": { title: "Camiños do Destino", tech: "Acrílico sobre táboa", desc: "Liñas que se entrecruzan creando camiños..." },
            "painting-6": { title: "Horizonte Infinito", tech: "Óleo sobre lenzo", desc: "Unha representación minimalista do mar e o ceo..." }
        }
    },
    ar: {
        nav: {
        ...
        paintings: {
            "painting-0": { title: "انعكاسات الروح", tech: "زيت على قماش", desc: "عمل فني عميق يستكشف خبايا النفس البشرية..." },
            "painting-1": { title: "هندسة الفوضى", tech: "أكريليك على لوح خشبي", desc: "لوحة تجسد التقاطع الجريء للأشكال الهندسية..." },
            "painting-2": { title: "شبح في الضباب", tech: "وسائط مختلطة على قماش", desc: "مزيج من الفحم والأكريليك والزيت يخلق جواً غامضاً..." },
            "painting-3": { title: "همسات المدينة", tech: "وسائط مختلطة على قماش", desc: "تعبير شعري عن الحركة والعزلة في المدن الكبرى..." },
            "painting-4": { title: "نظرة داخلية", tech: "أكريليك على قماش", desc: "بورتريه تعبيري يركز على قوة النظرات..." },
            "painting-5": { title: "طرق القدر", tech: "أكريليك على لوح خشبي", desc: "خطوط متقاطعة تعبر عن دروب الحياة..." },
            "painting-6": { title: "أفق لا نهائي", tech: "زيت على قماش", desc: "تمثيل تبسيطي لخط التقاء البحر والسماء..." }
        }
    },
    he: {
        nav: {
        ...
        paintings: {
            "painting-0": { title: "השתקפות הנשמה", tech: "שמן על קנבס", desc: "עבודה אינטימית החוקרת את מעמקי הנפש..." },
            "painting-1": { title: "גאומטריה של הכאוס", tech: "אקריליק וטקסטורות על עץ", desc: "ציור זה מציג מפגש נועז של מישורים..." },
            "painting-2": { title: "צללית בערפל", tech: "טכניקה מעורבת על קנבס", desc: "שילוב של פחם, אקריליק ושמן ליצירת אווירה מסתורية..." },
            "painting-3": { title: "לחישות אורבניות", tech: "טכניקה מעורבת על קנבס", desc: "ביטוי פואטי של תנועה ובדידות בכרך הגדול..." },
            "painting-4": { title: "מבט פנימי", tech: "אקריליק על קנבס", desc: "דיוקן אקספרסיבי המתמקד בעוצמת המבט..." },
            "painting-5": { title: "נתיבי הגורל", tech: "אקריליק על לוח עץ", desc: "קווים המצטלבים ומייצגים את שבילי החיים..." },
            "painting-6": { title: "אופק אינסופי", tech: "שמן על קנבס", desc: "ייצוג מינימליסטי של קו המפגש בין ים לשמים..." }
        }
    }
    ,
    de: {
        ...
        paintings: {
            "painting-0": { title: "Reflexionen der Seele", tech: "Öl auf Leinwand", desc: "Ein intimes Werk, das die Tiefen der menschlichen Selbstbeobachtung erforscht..." },
            "painting-1": { title: "Geometrie des Chaos", tech: "Acryl und Texturen auf Holz", desc: "Dieses Bild zeigt eine kühne Überschneidung geometrischer Ebenen..." },
            "painting-2": { title: "Silhouetten im Nebel", tech: "Mischtechnik auf Leinwand", desc: "Die Verschmelzung von Graphit, Kohle, Acryl und feinen Ölschichten..." },
            "painting-3": { title: "Urbane Flüstern", tech: "Mischtechnik auf Leinwand", desc: "Ein poetischer Ausdruck der Bewegung und Einsamkeit der Metropolen..." },
            "painting-4": { title: "Blick nach Innen", tech: "Acryl auf Leinwand", desc: "Ein ausdrucksstarkes Porträt, das sich auf die Kraft des Blicks konzentriert..." },
            "painting-5": { title: "Wege des Schicksals", tech: "Acryl auf Holz", desc: "Sich kreuzende Linien, die die Wege des Lebens darstellen..." },
            "painting-6": { title: "Unendlicher Horizont", tech: "Öl auf Leinwand", desc: "Eine minimalistische Darstellung des Treffens von Meer und Himmel..." }
        }
    },
    zh: {
        nav: {
        ...
        paintings: {
            "painting-0": { title: "心灵的折射", tech: "布面油画", desc: "探索人类自省深处的亲密作品..." },
            "painting-1": { title: "混沌的几何", tech: "木板丙烯与肌理", desc: "这幅画呈现了几何平面与厚重肌理的交织..." },
            "painting-2": { title: "雾中的剪影", tech: "布面混合媒介", desc: "木炭、丙烯与薄油画颜料的融合创造了神秘的氛围..." },
            "painting-3": { title: "都市的私语", tech: "布面混合媒介", desc: "大都市运动与孤独的诗意表达..." },
            "painting-4": { title: "内在的注视", tech: "布面丙烯", desc: "聚焦于目光力量的表现主义肖像..." },
            "painting-5": { title: "命运的轨迹", tech: "木板丙烯", desc: "交织的线条代表生命的路径..." },
            "painting-6": { title: "无尽的地平线", tech: "布面油画", desc: "海天交汇处的极简主义呈现..." }
        }
    },
    ja: {
        nav: {
        ...
        paintings: {
            "painting-0": { title: "魂の屈折", tech: "キャンバスに油彩", desc: "人間の自己観察の深淵を探求する親密な作品..." },
            "painting-1": { title: "カオスの幾何学", tech: "木板にアクリルとテクスチャ", desc: "幾何学的な平面と重厚なテクスチャの交差を表現した作品..." },
            "painting-2": { title: "霧の中のシルエット", tech: "キャンバスにミクストメディア", desc: "木炭、アクリル、薄い油絵の具の融合が神秘的な雰囲気を醸し出す..." },
            "painting-3": { title: "都会の囁き", tech: "キャンバスにミクストメディア", desc: "大都市のダイナミズムと孤独を詩的に表現した作品..." },
            "painting-4": { title: "内なる眼差し", tech: "キャンバスにアクリル", desc: "眼差しの力に焦点を当てた表現主義的な肖像画..." },
            "painting-5": { title: "運命の軌跡", tech: "木板にアクリル", desc: "人生の岐路を表す交差する線の表現..." },
            "painting-6": { title: "無限の水平線", tech: "キャンバスに油彩", desc: "空と海の出会いを極限までシンプルに描いた作品..." }
        }
    }
};